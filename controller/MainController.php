 ...
 */
class MainController extends abstract_controller
{
    public function __construct($route)
    {
        parent::__construct($route);
        $this->Initialization($route, array('main', 'ideology'), 0);
    }
    ...
    public function actionIndex()
    {
        ...
        $this->header = helper::get_Header_HTML('header_1_2ed.tpl.php',
                                           $this->title_text . ' | ' . $this->settings[$this->controller]['title_h'],
                                           $this
                                          );
        ...
        $this->left_menu =  helper::get_leftMenu_HTML('menu_left_sub.tpl.php', $this, '', $auth);
    ...
    public function actionUpdate()
    {
        ...
        if (isset($_POST['submitText'])) {
            ...
            /////////////// Голоса времен /////////////////////////////////////////////////////////////////////
            $glavy[2]['link'] = 'golosa' . $this->settings['language_c'] . '/2'; //var_dump($glavy); die();
            ///////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            // Построение
            $this->header = helper::get_Header_HTML('header_1_2ed.tpl.php',
                "Редактирование - " . $this->title_text . " | " . $this->settings[$this->controller]['title_h'],
                $this, array('str1'	    =>  $str1, 'str2'  	=>  $str2)
            );
            $menu = category::get_topMenu($this->settings);
            $this->menu = helper::get_topMenu_HTML('top_menu.tpl.php', $menu, $this);
            $this->left_menu =  helper::get_leftMenu_HTML('menu_left_sub.tpl.php', $this, '', 0);
    ...
    public function actionAdd()
    {
        ...
        if (isset($_POST['submitText'])) {
            ...
            // Построение
            $this->header = helper::get_Header_HTML('header_1_2ed.tpl.php',
                "Добавление записи в раздел " . $this->title_text . " | " . $this->settings[$this->controller]['title_h'],
                $this, array('str1'	    =>  $str1, 'str2'  	=>  $str2)
            );
            $menu = category::get_topMenu($this->settings);
            $this->menu = helper::get_topMenu_HTML('top_menu.tpl.php', $menu, $this);
