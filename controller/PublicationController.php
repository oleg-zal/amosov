...
class PublicationController extends abstract_controller
{
    public function __construct($route)
    {
        ...
        $this->Initialization($route, 'publication', 0);
    }

    public function actionIndex()
    {
        $this->glavy[163]['link'] = 'book' . $this->settings['language_c'] . '/';
        $this->glavy[498]['link'] = 'nature' . $this->settings['language_c'] . '/';
        $this->glavy[164]['link'] = 'about_amosov' . $this->settings['language_c'] . '/';
        $this->glavy[165]['link'] = 'selection' . $this->settings['language_c'] . '/';
        $this->glavy[166]['link'] = 'reality' . $this->settings['language_c'] . '/';
